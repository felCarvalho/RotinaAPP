      ...
      {verificarDataSearch() ? (
        dataSearch.map((t) => (
          <motion.div
            ...
            key={t?.id}
            className="mx-3 mb-4 flex flex-row justify-between items-center gap-4 overflow-hidden rounded-[25px] bg-gradient-to-r from-blue-50 p-3 shadow-sm shadow-blue-50 select-none"
          >
