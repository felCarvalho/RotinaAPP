  ...
  return (
    <div className="h-full rounded-[50px] bg-white shadow-sm shadow-blue-50">
      ...
      <div className="py-5 px-3.5">
        <div className="scroll-bar box-border h-90 overflow-y-auto pt-16">
          {DataConfig.map((c) => (
            <div
              key={c?.id}
              className="my-3 mx-1.5 flex flex-row items-center justify-between rounded-2xl bg-blue-100/5 px-3 py-4 shadow-sm shadow-blue-50"
              onDoubleClick={() => {
