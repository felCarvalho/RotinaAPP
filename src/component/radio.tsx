...
export function Radio({ children, id, checked, onChange, ariaLabel, classNameRadio, classNameLabel, name }: RadioType) {
  return (
    <motion.label
      whileTap={{ scale: 0.9 }}
    ...
    >
      ...
      />
      {children ?? <motion.span className="absolute top-1 left-1 h-4 w-4 rounded-full peer-checked:bg-blue-400"></motion.span>}
    </motion.label>
  );
}
