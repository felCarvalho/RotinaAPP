...
export function SearchTasks() {
  ...
  return (
    <motion.div
      ...
      key={""}
      className="flex flex-col items-start justify-between gap-4 overflow-hidden rounded-[25px] bg-linear-to-r from-blue-50/30 p-3 shadow-sm shadow-blue-50 select-none max-sm:flex-row max-sm:items-center"
    >
