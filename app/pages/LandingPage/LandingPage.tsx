  ...
  return (
    <div className="flex min-h-screen flex-col bg-white font-sans text-slate-900 selection:bg-blue-100 selection:text-blue-600">
      ...
      <nav className="flex items-center justify-between px-6 py-8 md:px-12 lg:px-24">
        ...
        <NavLink to="/login">
          <span className="text-sm font-medium text-slate-500 hover:text-slate-900 transition-colors">Entrar</span>
        </NavLink>
      </nav>
      ...
      <section className="flex flex-col items-center justify-between px-6 py-16 md:flex-row md:px-12 lg:px-24 lg:py-24">
        ...
        >
          <H1
            ...
            className="mb-6 text-4xl font-extrabold tracking-tight text-slate-900 md:text-6xl shadow-none!"
          />
          <P
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center md:justify-start">
            <NavLink to="/criar-conta">
              <Button type="button" className="group flex items-center gap-2 bg-slate-900! px-8 py-4 text-white shadow-none! hover:bg-slate-800!">
        ...
        <motion.div 
          ...
          className="mt-16 md:mt-0 md:w-1/2 flex justify-center lg:justify-end"
        >
          <img
      ...
      <section className="border-y border-slate-50 bg-slate-50/30 px-6 py-24 md:px-12 lg:px-24">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
          {features.map((feature, index) => (
            ...
            >
              <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-white text-slate-900 shadow-sm border border-slate-100">
                <FontAwesomeIcon icon={feature.icon} className="text-lg" />
              </div>
              <H3 title={feature.title} className="mb-3 text-lg font-bold text-slate-900" />
              <P title={feature.description} className="text-slate-500 leading-relaxed shadow-none!" />
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="px-6 py-24 text-center md:px-12 lg:px-24">
        ...
        >
          ...
          <H1 title="Transforme sua produtividade." className="mb-6 text-3xl font-bold text-white! md:text-4xl shadow-none!" />
          <P 
          ...
          />
          <NavLink to="/criar-conta">
            <Button type="button" className="bg-white! px-10 py-4 text-slate-900! shadow-none! hover:bg-slate-50!">
      ...
      <footer className="px-6 py-12 md:px-12 lg:px-24">
        <div className="flex flex-col items-center justify-between gap-6 border-t border-slate-100 pt-8 md:flex-row">
          <P title="© 2026 RotinaAPP por Felipe Carvalho" className="text-xs font-semibold text-slate-400 shadow-none!" />
          <div className="flex gap-8">
            <a href="#" className="text-xs font-semibold text-slate-400 hover:text-slate-600 transition-colors">Termos</a>
            <a href="#" className="text-xs font-semibold text-slate-400 hover:text-slate-600 transition-colors">Privacidade</a>
          </div>
        </div>
      </footer>
    </div>
